...
class VNet(nn.Module):
    def __init__(self,num_classes=2):
        ...
        self.softmax = f.softmax   #log_softmax
...
if __name__ == '__main__':
    ...
    model1 = VNet(2).to(device)#(num_classes = 2)  # .cuda()

    net = model1 #nnFormer(input_channels = 1)#.to(device)
    ...
    out = net(x)
    a = 1
    print('suhuaqiang de gcn', out.shape)
